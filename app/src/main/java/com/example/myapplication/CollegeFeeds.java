...
public class CollegeFeeds extends Fragment {
    ProgressBar progressBar;
    SwipeRefreshLayout mySwipeRefreshLayout;
    WebView webView;
    String url = "https://vignan.ac.in/blog/";
    //https://www.brabu.net/notice.php
    //https://vignan.ac.in/tutionfee.php
    public CollegeFeeds() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_college_feeds,container,false);
